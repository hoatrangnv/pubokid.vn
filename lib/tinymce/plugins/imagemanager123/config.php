<?php
	...
	$mcImageManagerConfig['preview.urlprefix'] = "http://media.healthplus.vn:8081/"; // domain name
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../Images/Uploaded/Share/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
